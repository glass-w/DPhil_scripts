...
AA3     = spl("TRP TYR PHE HIS HIH ARG LYS CYS ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY ACE NME NAC"+dnares3+rnares3) #@#
AA1     = spl("  W   Y   F   H   H   R   K   C   D   E   I   L   M   N   P   O   Q   S   T   V   A   G   J   B   B"+dnares1+rnares1) #@#
...
class CoarseGrained:
    ...
    # Protein backbone
    bb        = "N CA C O H HA H1 H2 H3 O1 O2 CTJ CTB HHC1 HHC2 HHC3"                                                                    #@#  
    # Lipid tails
...
#        "ALA":  nsplit(bb + " CB"),
        ...
        "VAL":  nsplit(bb,"CB HB CG1 HG11 HG12 HG13 CG2 HG21 HG22 HG23"),
#         "VAL":  nsplit(bb,"CB CG1 CG2"),
        ...
        "ACE":  nsplit(bb + "CTJ HH31 HH32 HH33"),
        "NME":  nsplit(bb + "CTB HH31 HH32 HH33"),
        "NAC":  nsplit(bb + "CTB HH31 HH32 HH33"),
...
class martini21:
    def __init__(self):
        ...
        self.bbtyp    = {                                                                   #                 #@#
                     ...
                     "NAC": spl(" N0    N0    N0    N0    N0    N0    N0    N0    N0"),# NAC specific    #@#
...
class Topology:
    ...
    def fromAminoAcidSequence(self,sequence,secstruc=None,links=None,breaks=None,
        ...
        for residue in chain.residues:
            for atom in residue:
                if atom[0] == "CA" or atom[0] == "CTJ" or atom[0] == "CTB":
        ...
        for resi,resname,bbb,sidechn,ss in zip(resid,self.sequence,bb,sc,self.secstruc):
            ...
            # All residue atoms
            # AHV avoid repetition of numbers 
