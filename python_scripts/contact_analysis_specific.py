...
u = mda.Universe("R1_PR100_r0_resid_90_190.gro", "R1_PR100_r0_resid_90_190.xtc")
...
def plot_hmap(data, names, resids):
    ...
    plt.suptitle('Mutant (1) Nav1.5: Residues < 4 Angstrom')
    plt.xlabel("Residue")
    plt.ylabel("Residue")
...
if __name__ == "__main__":
    ...
    os.system('ffmpeg -i frame_%04d.png -filter:v "setpts=1.0*PTS" movie.mp4')
