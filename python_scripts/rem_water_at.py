...
for particle in range(len(p_particles)):

    if p_particles_pos[particle][2] >= (0.5 * u.dimensions[2]):

        p_ul.append(p_particles_pos[particle][2])

    elif p_particles_pos[particle][2] <= (0.5 * u.dimensions[2]):

        p_ll.append(p_particles_pos[particle][2])
